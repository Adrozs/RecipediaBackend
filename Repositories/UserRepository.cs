...
namespace Recipedia.Repositories
{
    ...
    public class UserRepository : IUserRepository
    {
        ...
        public UserRepository(ApplicationContext context, UserManager<User> userManager, SignInManager<User> signInManager, AuthService authService)
        {
            _context = context;
        ...
        public async Task<IdentityResult> CreateAccountAsync(string email, string emailConfirm, string password, string passwordConfirm)
        {
            ...
            // Commented away email confirmation stuff as this is only MVP atm
            /*
        ...
        public async Task<IdentityResult> DeleteAccountAsync(string password, ClaimsPrincipal currentUser)
        {
            ...
            // OBS! change job/cv stuff with recipes !!!
